...
for(const t of [
  ...
  '"handoff": {','"palmier": {','"contractVersion": "opening-v1-palmier-handoff/v2"','"current": false','"src/data/openingV1.ts#openingV1Scenes"','"src/data/openingV1Sound.ts#openingV1SoundCues"','"opening-v1-palmier-timeline.csv"','"replacement_policy"','"opening-v1-palmier-sound-cues.csv"','"ambience_j_cut"','"shaBound": true',
