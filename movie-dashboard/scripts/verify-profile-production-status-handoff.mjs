...
console.log('Profile production-status handoff OK: Motion Studio final-render/DaVinci/final-approval states are visible and exportable from the Scene handoff UI even while blocked, without altering assembly-ready semantics or fabricating readiness.');
