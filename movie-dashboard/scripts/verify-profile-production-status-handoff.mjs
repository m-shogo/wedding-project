...
for(const t of ['"overallState": "ASSEMBLY_REQUIRED"','"assembly": {"state": "BLOCKED"}','"finalRender": {"state": "NOT_RUN"}','"davinciFinishing": {"state": "NOT_RUN"}','"finalDeliveryApproval": {"state": "NOT_RUN"}','"macDaVinciActual": "NOT_RUN"','"finalDeliveryApproved": false','"productionReady": false'])need(generated,t,`generated status missing ${t}`);
