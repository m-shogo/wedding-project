...
import {WeddingProjectRealMediaVisualReviewCard} from "./WeddingProjectRealMediaVisualReviewCard";
...
export function WeddingMediaIntakeChecklistCard({projectId}: {projectId: SceneProjectId}) {
  ...
  return (
    <>
      ...
      <WeddingProjectRealMediaVisualReviewCard projectId={projectId} />
