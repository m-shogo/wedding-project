      ...
      {session && evaluation ? (
        <div className="mt-3 space-y-2">
          ...
          <p className="border border-amber-200 dark:border-amber-800 p-2 text-[8px] leading-3 text-amber-800 dark:text-amber-200">
            eligible for separate Human promotion review: {eligibleCount}/9。automaticPromotionAllowed=false / productionReady=false。session import/evaluation report成功をproduction昇格へ読み替えません。
          </p>
        </div>
      ) : null}
    </details>
