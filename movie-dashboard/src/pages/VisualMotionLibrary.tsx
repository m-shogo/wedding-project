  ...
  return (
    <div>
      ...
      <section className="mb-8 border-l-2 border-emerald-600 pl-5">
        ...
        <h2 className="mt-1 text-xl font-bold text-navy-900 dark:text-sand-100">Native App Actual 9件を、検証根拠と一緒に公開する</h2>
        <p className="mt-2 text-sm leading-6 text-navy-600 dark:text-navy-300">
          ...
          他のMotion Kit presetは、31件の永続Remotion TESTEDと2件のsource-media Actual TESTEDを証拠種別ごとに分けている。Mask Reveal・Quiet Caption・Static Hero・Word Punch・Small Push・Slow Pull・Flash Soft・Char StaggerはDaVinci Actual、Hard Cut AccentはPalmier Actualまで到達済み。
        </p>
      </section>
