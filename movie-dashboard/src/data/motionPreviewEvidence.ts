...
export const motionPreviewEvidence: MotionPreviewEvidenceRecord[] = [
  ...
  // workflowRunId/artifactExpiresAtは存在しない。DaVinci Actual検証とは別扱いのまま。
  {
    ...
    classification: "CONCEPT",
    sourceType: "REPO_GENERATED",
    generatedAt: "2026-08-26T03:57:15Z",
    workflowRunId: null,
    artifactName: null,
    artifactDigest: "sha256:95762c2c2eff0cadf78a7da4c19907033523d92eb7196d76c2c1327faebd4305",
  ...
  },
  {
    ...
    humanVisualQa: {
      ...
      result: "PASS",
      observations: [
        "区間内frame10/20/30/37(全体frame1435/1445/1455/1462)を目視。矩形の色面wipeではなく、先端の尖ったchevron(矢羽根)状のclip-path図形が画面を左から右へ横切り、frame1462で画面全体を覆うことを確認。wipe-route-line(矩形バー+中央ライン)とは明確に異なる見た目。",
      ],
    },
    productionAuthority: false,
    notes: "以前は既知の限界(「shape」という名称に対し矩形色面wipeで近似していた)として記録していたが、TransitionWipeEngineへvariant='shape'(clip-pathによる角のある図形)を新規実装して解消した。",
  },
  {
