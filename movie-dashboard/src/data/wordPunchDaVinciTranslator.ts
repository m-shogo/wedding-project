...
const intensityScale: Record<WordPunchMotionIntensity, number> = {
  S: 0.55,
  M: 0.8,
  L: 1,
};
...
/**
 * Canonical TypographyRevealEngine(mode="punch") → DaVinci Text+ + Transform translation.
 *
 * The canonical motion scales the whole title from 1 + 0.18 * intensity to 1 over 0.5 seconds
 * with cubic-out easing while opacity follows the same entrance progress. We deliberately keep
 * Fusion input/property names out of this spec until a real Resolve Actual records them.
 */
