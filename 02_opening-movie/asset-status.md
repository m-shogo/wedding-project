...
|--------|------|----|--------|---------|------|
| 3 | 雲海（上から） | 89 | op_16_cloud_transition_ai.png | 1本 | 採点済み |
| 1-B | 薄い光の抽象背景 | 88 | op_02_boarding_pass_bg_ai.png | 1本 | 採点済み |
| 2-A | 飛行機窓・地上の遠景 | 87 | — | 0本 | 静止画なし（I2V不可） |
| 2-B | 飛行機窓・青空と雲 | 86 | op_03_airplane_window_clouds_ai.png | 1本 | 採点済み |
| 1-A-1 | 空港ロビーの光（朝） | 85 | op_11_narita_airport_lobby_ai.png | 3本 | 採点済み |
| 4-A-1 | ハワイの海・ゴールドの光 | 85 | op_07_hawaii_beach_ai.png | 2本 | 採点済み |
| 5-B | 光が差す扉 | 84 | op_10_chapel_door_ai.png | 1本 | 採点済み |
