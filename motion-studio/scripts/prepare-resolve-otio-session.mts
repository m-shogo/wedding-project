...
try {
  ...
  const nextAction = `Open Resolve manually in disposable contexts, capture exact live runtime identity, then execute ${canaryId} from plan.md. Compare plain OTIO, OTIOZ, Resolve-exported OTIO and clean reimport separately.`;
