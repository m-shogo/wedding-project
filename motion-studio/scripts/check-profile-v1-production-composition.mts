...
for (const token of [
  "'scripts/profile-v1-assembly-preflight.mts', '--strict'", "'ProfileV1'", "'out/profile/profile_v1.mp4'", "'scripts/check-profile-render.mts'",
...
console.log('Profile V1 production composition contracts OK: strict assembly gate → clean runtime-media+BGM render → technical media QA, without review chrome or fabricated Mac/production state.');
