...
import {weddingEditDurationInFrames} from './data/startWeddingEdit/generated';
...
export function StartMotionKitRoot() {
  return (
    <>
      ...
      <Composition id="JapaneseFriendsOpeningStartSyncV1" component={JapaneseFriendsOpeningStartSync} width={1920} height={1080} fps={30} durationInFrames={weddingEditDurationInFrames} />
    </>
  );
}
