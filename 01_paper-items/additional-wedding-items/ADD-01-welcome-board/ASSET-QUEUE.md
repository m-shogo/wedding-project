...
Status: `ASSET_IN_PROGRESS / WB-01_WB-02_WB-03_WB-04_ACCEPTED`
Date: 2026-08-02
...
- Mode: RGBA
- Alpha extrema: `0–205`; transparent exterior exists
- File size: 64,830 bytes
- SHA-256: `c1a05cbc3b3e36c8a255d6dd0a6ae09c414f4396154cc7c4fb5d6fb62866ac56`
- Drive ID: `1jt54tvLnk1CCVaBt3XhvEgqnw593_O1t`
- Drive readback: exact filename, MIME type `image/png`, and ADD-01 parent folder confirmed
- Visual intent: restrained compass with fine concentric rings, directional needles, sparse route orbit and paper plane; no text or fixed wedding copy
...
`WB-05_YOKOHAMA_ACCENT_TRANSPARENT_PNG_REVIEW`
