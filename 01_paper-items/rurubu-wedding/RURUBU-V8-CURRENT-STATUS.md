...
- RSL-211: facing-spread unity must not be simulated by arbitrary diagonal choreography.
...
- RSL-208: known official Figma upload submit was DNS-blocked at `mcp.figma.com`; do not repeat unchanged route without a material capability/network change.
...
- unchanged RSL-208 upload-submit failure path was not retried merely to consume activity
